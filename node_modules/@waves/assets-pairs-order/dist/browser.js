var OrderPairs = (function (exports) {
	'use strict';
	...
	var bs58$1 = /*#__PURE__*/Object.freeze({
		default: bs58,
		__moduleExports: bs58
	});
	...
	var utils_1 = utils.compareUint8Arrays;
	var utils_2 = utils.isPair;
	var utils_3 = utils.isEmptyArray;

	var utils$1 = /*#__PURE__*/Object.freeze({
		default: utils,
		__moduleExports: utils,
		compareUint8Arrays: utils_1,
		isPair: utils_2,
		isEmptyArray: utils_3
	});

	var mainnet = [{ "ticker": "USD", "id": "Ft8X1v1LTa1ABafufpaCWyVj8KkaxUWE6xBhW6sNFJck" }, { "ticker": "EUR", "id": "Gtb1WRznfchDnTh37ezoDTJ4wcoKaRsKqKjJjy7nm2zU" }, { "ticker": "CNY", "id": "DEJbZipbKQjwEiRjx2AqQFucrj5CZ3rAc4ZvFM8nAsoA" }, { "ticker": "TRY", "id": "2mX5DzVKWrAJw8iwdJnV2qtoeVG9h5nTDpTqC1wb1WEN" }, { "ticker": "BTC", "id": "8LQW8f7P5d5PZM7GtZEBgaqRPGSzS3DfPuiXrURJ4AJS" }, { "ticker": "WAVES", "id": "WAVES" }, { "ticker": "BCH", "id": "zMFqXuoyrn5w17PFurTqxB7GsS71fp9dfk6XFwxbPCy" }, { "ticker": "ETH", "id": "474jTeYx2r2Va35794tCScAXWJG9hU2HcgxzMowaZUnu" }, { "ticker": "LTC", "id": "HZk1mbfuJpmxU1Fs4AX5MWLVYtctsNcg6e2C6VKqK8zk" }, { "ticker": "DASH", "id": "B3uGHFRpSUuGEDWjqB9LWWxafQj8VTvpMucEyoxzws5H" }, { "ticker": "Monero", "id": "5WvPKSJXzVE2orvbkJ8wsQmmQKqTv9sGBPksV4adViw3" }, { "ticker": "ZEC", "id": "BrjUWjndUanm5VsJkbUip8VRYy6LWJePtxya3FNv4TQa" }];

	var mainnet$1 = /*#__PURE__*/Object.freeze({
		default: mainnet
	});

	var testnet = [{ "ticker": "WAVES", "id": "WAVES" }, { "ticker": "BTC", "id": "Fmg13HEHJHuZYbtJq8Da8wifJENq8uBxDuWoP9pVe2Qe" }, { "ticker": "USD", "id": "HyFJ3rrq5m7FxdkWtQXkZrDat1F7LjVVGfpSkUuEXQHj" }, { "ticker": "EUR", "id": "2xnE3EdpqXtFgCP156qt1AbyjpqdZ5jGjWo3CwTawcux" }, { "ticker": "CNY", "id": "6pmDivReTLikwYqQtJTv6dTcE59knriaodB3AK8T9cF8" }];

	var testnet$1 = /*#__PURE__*/Object.freeze({
		default: testnet
	});

	var arbitrary = [{ "ticker": "WAVES", "id": "WAVES" }];

	var arbitrary$1 = /*#__PURE__*/Object.freeze({
		default: arbitrary
	});

	var Base58 = ( bs58$1 && bs58 ) || bs58$1;

	var require$$0$1 = ( utils$1 && utils ) || utils$1;

	var MAINNET_RAW_DATA = ( mainnet$1 && mainnet ) || mainnet$1;

	var TESTNET_RAW_DATA = ( testnet$1 && testnet ) || testnet$1;

	var ARBITRARY_RAW_DATA = ( arbitrary$1 && arbitrary ) || arbitrary$1;

	var compareUint8Arrays$1 = require$$0$1.compareUint8Arrays,
	    isPair$1 = require$$0$1.isPair,
	    isEmptyArray$1 = require$$0$1.isEmptyArray;
	...
	var orderPair = function orderPair(predefinedList, first, second) {
	  ...
	  switch (true) {
	    ...
	    case !isFirstInList && isSecondInList:
	      return [first, second];
	    default:
	      return compareUint8Arrays$1(Base58.decode(first), Base58.decode(second)) ? [first, second] : [second, first];
	  }
	};
	...
	var createOrderPair = curry(orderPair);
	var MAINNET_DATA_1 = MAINNET_DATA;
	var TESTNET_DATA_1 = TESTNET_DATA;
	var ARBITRARY_DATA_1 = ARBITRARY_DATA;

	var src = {
	  createOrderPair: createOrderPair,
	  MAINNET_DATA: MAINNET_DATA_1,
	  TESTNET_DATA: TESTNET_DATA_1,
	  ARBITRARY_DATA: ARBITRARY_DATA_1
	};

	exports.default = src;
	exports.createOrderPair = createOrderPair;
	exports.MAINNET_DATA = MAINNET_DATA_1;
	exports.TESTNET_DATA = TESTNET_DATA_1;
	exports.ARBITRARY_DATA = ARBITRARY_DATA_1;
