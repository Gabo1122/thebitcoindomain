...
export declare type TSignData = ISignAuthData | ISignCoinomatConfirmation | ISignGetOrders | ISignCreateOrder | ISignCancelOrder | ISignTransferData | ISignIssue | ISignReissue | ISignBurn | ISignExchange | ISignLease | ISignCancelLeasing | ISignCreateAlias | ISignMassTransfer | IDataTxData | ISetScriptData | ISponsorshipData | ISetAssetScriptData | IScriptInvocationData;
